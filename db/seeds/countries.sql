...
-- Source: https://github.com/armetiz/SQL-Countries-ISO-3166-1


SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";

INSERT INTO `countries` (`country_id`, `iso_alpha_2`, `iso_alpha_3`, `name_cs`, `name_de`, `name_en`, `name_es`, `name_fr`, `name_it`, `name_nl`) VALUES
...
(826, 'GB', 'GBR', 'Velká Británie', 'Vereinigtes Königreich von Großbritannien', 'United Kingdom', 'Reino Unido', 'Royaume-Uni', 'Regno Unito', 'Verenigd Koninkrijk'),
