...
return [
  ...
  // ------------------------------------------------------------------------------------------------------------------- Movie Release
  "/movie/{0}/release"                         => "/film/{0}/veröffentlichung",
  ...
  "/movie/{0}/release/{1}/history"             => "/film/{0}/veröffentlichung/{1}/geschichte",
  // ------------------------------------------------------------------------------------------------------------------- Movie Release Image
  "/movie/{0}/release/{1}/image"               => "/film/{0}/veröffentlichung/{1}/bild",
  "/movie/{0}/release/{1}/image/upload"        => "/film/{0}/veröffentlichung/{1}/bild/hochladen",
  "/movie/{0}/release/{1}/image/{2}"           => "/film/{0}/veröffentlichung/{1}/bild/{2}",
