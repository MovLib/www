...
class HelpTest extends \MovLib\Test\TestCase {
  ...
  public function testToStringNoIdPopup() {
    $this->assertEquals(
      ...
      (new Help("Hello World!"))->__toString()
    );
  }
  ...
  public function testToStringIdPopup() {
    $this->assertEquals(
      ...
      (new Help("Hello World!", "phpunit"))->__toString()
    );
  }
  ...
  public function testToStringNoIdNoPopup() {
    $this->assertEquals(
      ...
      (new Help("Hello World!", null, false))->__toString()
    );
  }
  ...
  public function testToStringIdNoPopup() {
    $this->assertEquals(
      ...
      (new Help("Hello World!", "phpunit", false))->__toString()
    );
  }
