...
CREATE TABLE IF NOT EXISTS `movlib`.`posters` (
  ...
  `language_code` CHAR(2) CHARACTER SET 'ascii' NOT NULL COMMENT 'The poster’s ISO alpha-2 language code.',
...
CREATE TABLE IF NOT EXISTS `movlib`.`lobby_cards` (
  ...
  `language_code` CHAR(2) CHARACTER SET 'ascii' NOT NULL COMMENT 'The lobby card’s ISO alpha-2 language code.',
...
CREATE TABLE IF NOT EXISTS `movlib`.`backdrops` (
  ...
  `language_code` CHAR(2) CHARACTER SET 'ascii' NOT NULL COMMENT 'The backdrop’s ISO alpha-2 language code.',
