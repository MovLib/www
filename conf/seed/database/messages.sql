...
('Original title: “{0}”', COLUMN_CREATE('de', 'Originaltitel: „{0}”')),
...
('Random Person', COLUMN_CREATE('de', 'Zufällig Person')),
...
('“{original_title}” ({0}original title{1})', COLUMN_CREATE('de', '„{original_title}” ({0}Originaltitel{1})')),
...
('There can be various reasons why you might see this error message. If you feel that receiving this error is a mistake please {0}contact us{1}.', COLUMN_CREATE('de', 'Es kann viele verschiedene Gründe für diese Fehlermeldung geben. Solltest du der Meinung sein, dass dieser Fehler nicht korrekt ist {0}kontaktiere unse{1}.')),
