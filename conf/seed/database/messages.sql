...
('No jobs available. Please go to a movie or serial page and add them there.', COLUMN_CREATE('de', 'Keine Jobs vorhanden. Bitte gehe zu einer Film- oder Serienseite und füge diese dort hinzu.')),
