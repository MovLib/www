-- The Wikipedia texts are simple seed placeholders. We need to write our own descriptions and re-evaluate all genres
-- because there are huge differences from region to region (even between USA and Austria).
