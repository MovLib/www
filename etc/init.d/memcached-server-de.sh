...
### BEGIN INIT INFO
# Provides:           memcached-server-de
# Required-Start:     $local_fs $remote_fs $network $syslog $named
# Required-Stop:      $local_fs $remote_fs $network $syslog $named
# Default-Start:      2 3 4 5
# Default-Stop:       0 1 6
# Short-Description:  memcached-server-de LSB init script
# Description:        memcached-server-de Linux Standards Base compliant init script.
### END INIT INFO
...
# -----------------------------------------------------------------------------
# memcached-server-de Linux Standards Base compliant init script.
#
