...
CREATE TABLE IF NOT EXISTS `movlib`.`revisions` (
  ...
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT 'The user’s unique identifier.',
  `commit_msg` BLOB NOT NULL COMMENT 'The revision’s commit message.',
  `data` BLOB NOT NULL COMMENT 'The revision’s data.',
  `language_code` CHAR(2) NOT NULL COMMENT 'The commit message’s ISO alpha-2 language code.',
...
CREATE TABLE IF NOT EXISTS `movlib`.`image_revisions` (
  ...
  `commit_msg` BLOB NOT NULL COMMENT 'The image revision’s commit message.',
