...
CREATE TABLE IF NOT EXISTS `movlib`.`users` (
  ...
  `count_lists` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The user’s total number of lists.',
  `count_uploads` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The user’s total number of uploads.',
  `count_contributions` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The user’s total number of contributions.',
...
CREATE TABLE IF NOT EXISTS `movlib`.`jobs` (
  ...
  `dyn_titles_sex1` BLOB NOT NULL COMMENT 'The job’s male title in various languages. Keys are ISO alpha-2 language codes.',
  `dyn_titles_sex2` BLOB NOT NULL COMMENT 'The job’s female title in various languages. Keys are ISO alpha-2 language codes.',
...
-- -----------------------------------------------------
-- Table `movlib`.`events_awards_categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `movlib`.`events_awards_categories` (
  `event_id` BIGINT UNSIGNED NOT NULL COMMENT 'The event’s unique identifier.',
  `award_category_id` BIGINT UNSIGNED NOT NULL COMMENT 'The award category’s unique identifier.',
  PRIMARY KEY (`event_id`, `award_category_id`),
  INDEX `fk_events_awards_categories_awards_categories` (`award_category_id` ASC),
  CONSTRAINT `fk_events_awards_categories_events`
    FOREIGN KEY (`event_id`)
    REFERENCES `movlib`.`events` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_events_awards_categories_awards_categories`
    FOREIGN KEY (`award_category_id`)
    REFERENCES `movlib`.`awards_categories` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Contains all award categories for events.';

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `movlib`.`revision_entities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `movlib`.`revision_entities` (
  `id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'The revision entity type’s unique identifier.',
...
-- -----------------------------------------------------
-- Table `movlib`.`revisions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `movlib`.`revisions` (
  `id` DATETIME NOT NULL COMMENT 'The revision’s datetime.',
  `revision_entity_id` TINYINT UNSIGNED NOT NULL COMMENT 'The revision entity type’s unique identifier.',
  `entity_id` BIGINT UNSIGNED NOT NULL COMMENT 'The entity’s unique identifier, within a type.',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT 'The user’s unique identifier.',
  `data` BLOB NULL COMMENT 'The revision’s data.',
  PRIMARY KEY (`id`, `revision_entity_id`, `entity_id`),
  INDEX `fk_revisions_users_idx` (`user_id` ASC),
  CONSTRAINT `fk_revisions_revision_entities`
    FOREIGN KEY (`revision_entity_id`)
    REFERENCES `movlib`.`revision_entities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_revisions_users`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table containing revisions of all entities.'
ROW_FORMAT = COMPRESSED
KEY_BLOCK_SIZE = 8;
