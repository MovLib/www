...
CREATE TABLE IF NOT EXISTS `movlib`.`jobs` (
  ...
  `count_series_copy1` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The job’s total number of series.',
  `count_releases` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The job’s total number of series.',
