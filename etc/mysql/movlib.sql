...
-- 05/16/14 19:15:26
-- Model: MovLib schema    Version: 0.1
...
CREATE TABLE IF NOT EXISTS `movlib`.`movies` (
  ...
  `rating` FLOAT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The Bayes\'theorem rating of this movie.' /* comment truncated */ /*
...
CREATE TABLE IF NOT EXISTS `movlib`.`users` (
  ...
  `sex` TINYINT UNSIGNED NULL DEFAULT 0 COMMENT 'The user\'s sex according to ISO 5218.' /* comment truncated */ /*
0 = not known
1 = male
2 = female
9 = not applicable*/,
...
CREATE TABLE IF NOT EXISTS `movlib`.`places` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Contains unique place information (OpenStreetMap node ID, latitude, longitude).';
...
CREATE TABLE IF NOT EXISTS `movlib`.`causes_of_death` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Contains all available causes of death including translations.';
...
CREATE TABLE IF NOT EXISTS `movlib`.`persons` (
  ...
  `sex` TINYINT NOT NULL DEFAULT 0 COMMENT 'The person\'s sex according to ISO 5218.' /* comment truncated */ /*
0 = not known
1 = male
2 = female
9 = not applicable*/,
...
CREATE TABLE IF NOT EXISTS `movlib`.`movies_crew` (
  ...
  `movie_id` BIGINT UNSIGNED NOT NULL COMMENT 'The movie’s unique ID.',
  `job_id` BIGINT UNSIGNED NOT NULL COMMENT 'The job’s unique identifier. Several important jobs have fixed identifier' /* comment truncated */ /*.
1: Acting
2: Direction
3: Production
4: Screenwriting*/,
...
CREATE TABLE IF NOT EXISTS `movlib`.`series` (
  ...
  `rating` FLOAT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'The Bayes\'theorem rating of the series.' /* comment truncated */ /*
rating = (s / (s + m)) * N + (m / (s + m)) * K
...
The same formula is used by IMDb and OFDb.*/,
  `status` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'One of the \\\\MovLib\\\\Data\\\\Series\\\\Series::STATUS_ constants.' /* comment truncated */ /*0 => unknown,
1 => new,
2 => returning,
3 => final season,
4 => ended,
...
CREATE TABLE IF NOT EXISTS `movlib`.`series_episodes` (
  ...
  CONSTRAINT `fk_series_episodes_series`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Contains all episode data of episodes belonging to seasons which belong to series.'
ROW_FORMAT = COMPRESSED
KEY_BLOCK_SIZE = 8;
...
CREATE TABLE IF NOT EXISTS `movlib`.`lobby_cards` (
  ...
  CONSTRAINT `fk_lobby_cards_deletion_requests`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table containing all information related to movie lobby cards.'
ROW_FORMAT = COMPRESSED
KEY_BLOCK_SIZE = 8;
...
CREATE TABLE IF NOT EXISTS `movlib`.`display_posters` (
  ...
  CONSTRAINT `fk_display_posters_posters`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table containing information on which poster should be used for which language as display poster on the movie details page.';
...
CREATE TABLE IF NOT EXISTS `movlib`.`movies_display_titles` (
  ...
  CONSTRAINT `fk_movies_display_titles`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table containing information on which title should be used for which language as display title on various listings.';
...
CREATE TABLE IF NOT EXISTS `movlib`.`movies_display_taglines` (
  ...
  CONSTRAINT `fk_movies_display_taglines`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table containing information on which tagline should be used for which language as display tagline on various listings.';
...
CREATE TABLE IF NOT EXISTS `movlib`.`movies_original_titles` (
  ...
  CONSTRAINT `fk_movies_original_titles_movies`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table to create correct circular reference between titles and the original title of a movie.';
...
CREATE TABLE IF NOT EXISTS `movlib`.`series_original_titles` (
  ...
  CONSTRAINT `fk_series_original_titles_series_titles`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Table to create correct circular reference between titles and the original title of a series.';
