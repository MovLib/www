...
location ^~ <?= $this->r("/movie") ?> {
  ...
  # -------------------------------------------------------------------------------------------------------------------- Release
  <?php $this->setRoutesNamespace("Movie\\Release") ?>


  location ~* '^<?= $this->rp("/movie/{0}/releases") ?>$' {
    <?= $this->set("Index") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->cache() ?>
  }

  location ~* '^<?= $this->r("/movie/{0}/release/create") ?>$' {
    <?= $this->set("Create") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->cache() ?>
  }

  <?= $this->redirectSingularToPlural("/movie/{0}/release", "/movie/{0}/releases") ?>

  location ~* '^<?= $this->r("/movie/{0}/release/{1}") ?>$' {
    <?= $this->set("Show") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  }

  location ~* '^<?= $this->r("/movie/{0}/release/{1}/edit") ?>$' {
    <?= $this->set("Edit") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/history") ?>$' {
    <?= $this->set("History") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/delete") ?>$' {
    <?= $this->set("Delete") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  ...
  # -------------------------------------------------------------------------------------------------------------------- Release Image
  <?php $this->setRoutesNamespace("Movie\\Release\\Image") ?>


  location ~* '^<?= $this->rp("/movie/{0}/release/{1}/images") ?>$' {
    <?= $this->set("Index") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  ...
  <?= $this->redirectSingularToPlural("/movie/{0}/release/{1}/image", "/movie/{0}/release/{1}/images") ?>

  location ~* '^<?= $this->r("/movie/{0}/release/{1}/image/upload") ?>$' {
    <?= $this->set("Create") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->cache() ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/image/{2}") ?>$' {
    <?= $this->set("Show") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->set('$3', "image_id") ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/image/{2}/edit") ?>$' {
    <?= $this->set("Edit") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->set('$3', "image_id") ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/image/{2}/history") ?>$' {
    <?= $this->set("History") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->set('$3', "image_id") ?>
  ...
  location ~* '^<?= $this->r("/movie/{0}/release/{1}/image/{2}/delete") ?>$' {
    <?= $this->set("Delete") ?>
    <?= $this->set('$1', "movie_id") ?>
    <?= $this->set('$2', "release_id") ?>
    <?= $this->set('$3', "image_id") ?>
