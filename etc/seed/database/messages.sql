...
('Create Person', COLUMN_CREATE('de', 'Person Anlegen')),
('Create Company', COLUMN_CREATE('de', 'Unternehmen Anlegen')),
('Create Award', COLUMN_CREATE('de', 'Auszeichnung Anlegen')),
('Create Genre', COLUMN_CREATE('de', 'Genre Anlegen')),
('Create Job', COLUMN_CREATE('de', 'Tätigkeit Anlegen')),
('Create Category', COLUMN_CREATE('de', 'Kategorie Anlegen')),
('Create', COLUMN_CREATE('de', 'Anlegen')),
...
('Categories', COLUMN_CREATE('de', 'Kategorien')),
('Categories of {0}', COLUMN_CREATE('de', 'Kategorien von {0}')),
