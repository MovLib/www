...
return [
  ...
  // ------------------------------------------------------------------------------------------------------------------- Help
  "/help"                                      => "/hilfe",
  "/help/search"                               => "/hilfe/suche",
  "/help/{0}"                                  => "/hilfe/{0}",
  "/help/{0}/{1}"                              => "/hilfe/{0}/{1}",
  "/help/{0}/{1}/{2}"                          => "/hilfe/{0}/{1}/{2}",
  "/help/database"                             => "/hilfe/datenbank",
  "/help/database/movies"                      => "/hilfe/datenbank/filme",
  "/help/database/movies/{0}"                  => "/hilfe/datenbank/filme/{0}",
  "/help/database/series"                      => "/hilfe/datenbank/serien",
  "/help/database/series/{0}"                  => "/hilfe/datenbank/serien/{0}",
  "/help/database/releases"                    => "/hilfe/datenbank/veröffentlichungen",
  "/help/database/releases/{0}"                => "/hilfe/datenbank/veröffentlichungen/{0}",
  "/help/database/persons"                     => "/hilfe/datenbank/personen",
  "/help/database/persons/{0}"                 => "/hilfe/datenbank/personen/{0}",
  "/help/database/companies"                   => "/hilfe/datenbank/unternehmen",
  "/help/database/companies/{0}"               => "/hilfe/datenbank/unternehmen/{0}",
  "/help/database/awards"                      => "/hilfe/datenbank/auszeichnungen",
  "/help/database/awards/{0}"                  => "/hilfe/datenbank/auszeichnungen/{0}",
  "/help/database/events"                      => "/hilfe/datenbank/events",
  "/help/database/events/{0}"                  => "/hilfe/datenbank/events/{0}",
  "/help/database/genres"                      => "/hilfe/datenbank/genres",
  "/help/database/genres/{0}"                  => "/hilfe/datenbank/genres/{0}",
  "/help/database/jobs"                        => "/hilfe/datenbank/tätigkeiten",
  "/help/database/jobs/{0}"                    => "/hilfe/datenbank/tätigkeiten/{0}",
  "/help/database/{0}"                         => "/hilfe/datenbank/{0}",
  "/help/marketplace"                          => "/hilfe/marktplatz",
  "/help/marketplace/{0}"                      => "/hilfe/marktplatz/{0}",
  "/help/community"                            => "/hilfe/community",
  "/help/community/deletion-requests"          => "/hilfe/community/löschanträge",
  "/help/community/deletion-requests/{0}"      => "/hilfe/community/löschanträge/{0}",
  "/help/community/{0}"                        => "/hilfe/community/{0}",
  // ------------------------------------------------------------------------------------------------------------------- Country
