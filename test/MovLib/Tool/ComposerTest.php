...
use \MovLib\Tool\Composer;

/**
 * @coversDefaultClass \MovLib\Tool\Composer
 ...
 * @since 0.0.1-dev
 */
class ComposerTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Tool\Composer */
  protected $composer;
  ...
  /**
   * @covers ::visualphpunit
   * @todo Implement visualphpunit
   */
  public function testVisualphpunit() {
    $this->markTestIncomplete("This test has not been implemented yet.");
  }
  ...
  /**
   * @covers ::postPackageInstall
   * @todo Implement postPackageInstall
   */
