...
use \MovLib\Tool\Console\Application;

/**
 * @coversDefaultClass \MovLib\Tool\Console\Application
 ...
 * @since 0.0.1-dev
 */
class ApplicationTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Tool\Console\Application */
  ...
  /**
   * @covers ::importCommands
   * @todo Implement importCommands
   */
