...
use \MovLib\Tool\Console\Command\Development\SkeletonGenerator;

/**
 * @coversDefaultClass \MovLib\Tool\Console\Command\Development\SkeletonGenerator
 ...
 * @since 0.0.1-dev
 */
class SkeletonGeneratorTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Tool\Console\Command\Development\SkeletonGenerator */
   ...
   */
  public function testSkeletonExtend() {
    $this->markTestIncomplete("This test has not been implemented yet.");
  }

  /**
   * @covers ::skeletonNew
   * @todo Implement skeletonNew
   */
  public function testSkeletonNew() {
    $this->markTestIncomplete("This test has not been implemented yet.");
  }
