...
use \MovLib\Presentation\ImageDetails\MoviePosterDetails;

/**
 * @coversDefaultClass \MovLib\Presentation\ImageDetails\MoviePosterDetails
 ...
 * @since 0.0.1-dev
 */
class MoviePosterDetailsTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\ImageDetails\MoviePosterDetails */
  protected $moviePosterDetails;
  ...
  protected function setUp() {
    $this->moviePosterDetails = new MoviePosterDetails();
  }
