...
use \MovLib\Presentation\ImageDetails\MoviePhotoDetails;

/**
 * @coversDefaultClass \MovLib\Presentation\ImageDetails\MoviePhotoDetails
 ...
 * @since 0.0.1-dev
 */
class MoviePhotoDetailsTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\ImageDetails\MoviePhotoDetails */
  protected $moviePhotoDetails;
  ...
  protected function setUp() {
    $this->moviePhotoDetails = new MoviePhotoDetails();
  }
