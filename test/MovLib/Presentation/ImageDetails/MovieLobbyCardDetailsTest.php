...
use \MovLib\Presentation\ImageDetails\MovieLobbyCardDetails;

/**
 * @coversDefaultClass \MovLib\Presentation\ImageDetails\MovieLobbyCardDetails
 ...
 * @since 0.0.1-dev
 */
class MovieLobbyCardDetailsTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\ImageDetails\MovieLobbyCardDetails */
  protected $movieLobbyCardDetails;
  ...
  protected function setUp() {
    $this->movieLobbyCardDetails = new MovieLobbyCardDetails();
  }
