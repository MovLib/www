...
/**
 * @coversDefaultClass \MovLib\Presentation\Email\User\EmailChange
 ...
 * @since 0.0.1-dev
 */
class EmailChangeTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\Email\User\EmailChange */
