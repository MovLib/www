...
use \MovLib\Presentation\Gallery\MoviePosterGallery;

/**
 * @coversDefaultClass \MovLib\Presentation\Gallery\MoviePosterGallery
 ...
 * @since 0.0.1-dev
 */
class MoviePosterGalleryTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\Gallery\MoviePosterGallery */
  protected $moviePosterGallery;
  ...
  protected function setUp() {
    $this->moviePosterGallery = new MoviePosterGallery();
  }
