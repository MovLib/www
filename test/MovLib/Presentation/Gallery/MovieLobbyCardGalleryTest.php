...
use \MovLib\Presentation\Gallery\MovieLobbyCardGallery;

/**
 * @coversDefaultClass \MovLib\Presentation\Gallery\MovieLobbyCardGallery
 ...
 * @since 0.0.1-dev
 */
class MovieLobbyCardGalleryTest extends \MovLib\TestCase {


  // ------------------------------------------------------------------------------------------------------------------- Properties


  /** @var \MovLib\Presentation\Gallery\MovieLobbyCardGallery */
  protected $movieLobbyCardGallery;
  ...
  protected function setUp() {
    $this->movieLobbyCardGallery = new MovieLobbyCardGallery();
  }
