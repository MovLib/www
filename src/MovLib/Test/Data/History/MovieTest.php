...
class MovieTest extends \MovLib\Test\TestCase {
  ...
  public function testGetLastCommitHash() {
    ...
    $this->assertEquals(
      $this->invoke($this->movie, "getLastCommitHash"), $this->invoke($this->movie, "getLastCommits")[0]["hash"]
    );
  }
  ...
  public function testGetFileAtRevision() {
    ...
    $this->assertEquals(
      "The foobar is a lie", $this->movie->getFileAtRevision("original_title", "HEAD^1")
    );
  }
