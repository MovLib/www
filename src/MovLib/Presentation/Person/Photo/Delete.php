...
class Delete extends \MovLib\Presentation\AbstractPresenter {
  ...
  public function __construct() {
    ...
    // Initialize page.
    $this->initPage($this->intl->t("Delete Photo of {person_name}", [ "person_name" => $this->person->name ]));
    $this->pageTitle = $this->intl->t("Delete Photo of {person_name}", [ "person_name" => "<a href='{$this->person->route}'>{$this->person->name}</a>" ]);
  ...
  public function getContent() {
    $this->alerts .= new Alert(
      $this->intl->t("The delete person photo feature isn’t implemented yet."),
