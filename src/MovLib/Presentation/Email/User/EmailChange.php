...
class EmailChange extends \MovLib\Presentation\Email\AbstractEmail {
  ...
  protected function getHtmlBody() {
    ...
    return
      ...
      "<p>{$i18n->t("You (or someone else) requested to change your account’s email address. You may now confirm your new email address by {0}clicking this link{1}.", [
...
{$i18n->t("You (or someone else) requested to change your account’s email address. You may now confirm your new email address by clicking the following link or copying and pasting it to your browser:")}
