...
class Discussion extends \MovLib\Presentation\Job\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle = $i18n->t("Discussion of {0}", [ "<a href='{$this->job->route}'>{$this->job->name}</a>" ]);
  ...
  protected function getPageContent() {
    global $i18n;
    return new \MovLib\Presentation\Partial\Alert($i18n->t("The {0} feature isn’t implemented yet.", [ $i18n->t("discuss job") ]), $i18n->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
