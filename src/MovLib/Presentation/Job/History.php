...
class History extends \MovLib\Presentation\Job\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle = $this->intl->t("History of {0}", [ "<a href='{$this->job->route}'>{$this->job->name}</a>" ]);
  ...
  protected function getPageContent() {
    return new \MovLib\Presentation\Partial\Alert($this->intl->t("The {0} feature isn’t implemented yet.", [ $this->intl->t("job history") ]), $this->intl->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
