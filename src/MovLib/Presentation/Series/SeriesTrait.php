...
trait SeriesTrait {
   ...
   */
  final protected function getStructuredDisplayTitle(\MovLib\Data\Series\Series $series, $linkTitle = true, $linkYears = false) {
   ...
   *   equal.
   */
  final protected function getStructuredOriginalTitle(\MovLib\Data\Series\Series $series, $wrap = null, array $wrapAttributes = null) {
