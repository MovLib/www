...
class Delete extends \MovLib\Presentation\AbstractPresenter {
  ...
  public function init() {
    ...
    $pageTitle    = $this->intl->t("Delete {0}", [ $this->entity->displayTitle ]);
    return $this
      ->initPage($pageTitle, $pageTitle, $this->intl->t("Delete"))
      ->sidebarInitToolbox($this->entity, $this->getSidebarItems())
      ->initLanguageLinks("/{$this->entity->set->singularKey}/{0}/delete", $this->entity->id)
  ...
  public function getContent() {
    return $this->checkBackLater("delete series");
  }
