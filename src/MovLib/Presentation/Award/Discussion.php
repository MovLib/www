...
class Discussion extends \MovLib\Presentation\Award\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle = $i18n->t("Discussion of {0}", [ "<a href='{$this->award->route}'>{$this->award->name}</a>" ]);
  ...
  protected function getPageContent() {
    global $i18n;
    return new \MovLib\Presentation\Partial\Alert($i18n->t("The {0} feature isn’t implemented yet.", [ $i18n->t("discuss award") ]), $i18n->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
