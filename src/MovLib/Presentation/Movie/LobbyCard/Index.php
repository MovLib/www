...
class Index extends \MovLib\Presentation\AbstractIndexPresenter {
  ...
  public function getNoItemsContent() {
    return $this->calloutInfo("<p>{$this->intl->t("We couldn’t find any posters for this movie.")}</p>", $this->intl->t("No Lobby Cards"));
  }
  ...
  public function init() {
    $this->initIndex(new \MovLib\Stub\Data\Dummy\DummySet($this->container), $this->intl->t("Lobby Cards"), null);
  }
