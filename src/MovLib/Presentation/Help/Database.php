...
/**
 * Defines the database category index presentation.
 *
 ...
 * @since 0.0.1-dev
 */
final class Database extends \MovLib\Presentation\Help\AbstractCategory {

  /**
   * {@inheritdoc}
   */
  public function init() {
    $this->category = new Category($this->diContainerHTTP, 1);
    parent::init();
  }
