...
class Discussion extends \MovLib\Presentation\Genre\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle = $this->intl->t("Discussion of {0}", [ "<a href='{$this->genre->route}'>{$this->genre->name}</a>" ]);
  ...
  protected function getPageContent() {
    return new \MovLib\Presentation\Partial\Alert($this->intl->t("The {0} feature isn’t implemented yet.", [ $this->intl->t("discuss genre") ]), $this->intl->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
