...
final class Index extends \MovLib\Presentation\AbstractIndexPresenter {
   ...
   */
  protected function formatListingItem(\MovLib\Core\Entity\EntityInterface $event, $delta) {
    return
        ...
        "<article>" .
          ...
          "<div class='s s9'>" .
            "<div class='fr'>" .
              ...
              "<a class='ico ico-series label' href='{$this->intl->r("/event/{0}/series", $event->id)}' title='{$this->intl->tp(-1, "Series")}'>{$event->seriesCount}</a>" .
