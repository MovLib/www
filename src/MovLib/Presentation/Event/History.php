...
class History extends \MovLib\Presentation\Event\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle     =
      $i18n->t("History of {0}", [ "<a href='{$this->event->route}'>{$this->event->name}</a>" ])
    ;
  ...
  protected function getPageContent() {
    global $i18n;
    return new \MovLib\Presentation\Partial\Alert($i18n->t("The {0} feature isn’t implemented yet.", [ $i18n->t("event history") ]), $i18n->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
