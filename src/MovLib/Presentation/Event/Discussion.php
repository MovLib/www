...
class Discussion extends \MovLib\Presentation\Event\AbstractBase {
  ...
  public function __construct() {
    ...
    $this->pageTitle     =
      $this->intl->t("Discussion of {0}", [ "<a href='{$this->event->route}'>{$this->event->name}</a>" ])
    ;
  ...
  protected function getPageContent() {
    return new \MovLib\Presentation\Partial\Alert($this->intl->t("The {0} feature isn’t implemented yet.", [ $this->intl->t("discuss event") ]), $this->intl->t("Check back later"), \MovLib\Presentation\Partial\Alert::SEVERITY_INFO);
  }
