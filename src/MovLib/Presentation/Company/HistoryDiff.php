...
/**
 * Defines the company history diff presentation.
 *
...
final class HistoryDiff extends \MovLib\Presentation\AbstractPresenter {
  ...
  public function init() {
    // We simply assume that the company actually exists.
    $historyRoute = $this->intl->r("/company/{0}/history", $_SERVER["COMPANY_ID"]);
    ...
    // Now we try to instantiate the actual company for presentation purposes. This will throw the not found exception if
    // the company doesn't exist at all.
    ...
    $this->breadcrumb->addCrumb($this->intl->r("/companies"), $this->intl->t("Companies"));
