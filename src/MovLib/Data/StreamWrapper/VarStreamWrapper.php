...
/**
 * Defines the var stream wrapper for the <code>"var://"</code> scheme.
 *
 ...
 * @since 0.0.1-dev
 */
final class VarStreamWrapper extends AbstractLocalStreamWrapper {
  ...
  public function getPath() {
    global $kernel;
    return "{$kernel->documentRoot}/var";
  }
