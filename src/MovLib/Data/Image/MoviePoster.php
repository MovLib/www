 ...
 * @since 0.0.1-dev
 */
class MoviePoster extends \MovLib\Data\Image\AbstractMovieImage {
  ...
  public function __construct($movieId = null, $movieTitle = null, $id = null) {
    parent::__construct($id, $movieId, $movieTitle, $i18n->t("Poster"), $i18n->t("Posters"), "poster", "posters");
  }
